...
global.reloadHandler = async function(restatConn) {
    ...
    conn.welcome = 'اووو عضو جديد منور يا اهوش\n\n @subject, @user\n'
    conn.bye = '\n  غادر كلب المجموعة \n@user 🐶'
    conn.spromote = '@user *اووووو رفعوا رتبتك* إلى المشرف '
    conn.sdemote = '@user *ههههههه نزلو رتبتك* من المشرف'
    conn.sDesc = 'احيييي من زمان ليش ما غيرت الوصف إلى \n@desc'
    conn.sSubject = 'احيييه ليش تغيير اسم المجموعة إلى \n@subject'
    conn.sIcon = 'شوفو غير الصورة الجماعية!'
    conn.sRevoke = 'الاهوش غير  رابط المجموعة إلى \n@revoke'
    conn.sAnnounceOn = 'تم إغلاق المجموعة!\انيهاهاهاهاها ما بتقدرو ترسلو رسائل.'
